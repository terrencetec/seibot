...
import numpy as np
import control
ff = foton.FilterFile("L1ISIHAM8.txt")

# Sensor Correction X

def ham8_sens_cor_x():
    s = control.tf("s")
    hsc_x_1 = ff["HAM8_SENSCOR_X_UNCOR_FILT1"][1]
    hsc_x_2 = ff["HAM8_SENSCOR_X_UNCOR_FILT1"][2]
...
def ham8_sens_cor_y():
    s = control.tf("s")
    hsc_y_1 = ff["HAM8_SENSCOR_Y_UNCOR_FILT1"][1]
    hsc_y_2 = ff["HAM8_SENSCOR_Y_UNCOR_FILT1"][2]
...
def ham8_sens_cor_z():
    s = control.tf("s")
    hsc_z_1 = ff["HAM8_SENSCOR_Z_NORM_FILT1"][0]
...
def ham8_blend_x():
    s = control.tf("s")
    blend_1_a = ff["HAM8_BLND_X_SUPERSENS1_DISP"][0]
    blend_1_b = ff["HAM8_BLND_X_SUPERSENS1_DISP"][2]
    ...
    blend_2 = ff["HAM8_BLND_X_SUPERSENS1_INERT_HI"][0]
...
def ham8_blend_y():
    s = control.tf("s")
    blend_1_a = ff["HAM8_BLND_Y_SUPERSENS1_DISP"][0]
    blend_1_b = ff["HAM8_BLND_Y_SUPERSENS1_DISP"][2]
    ...
    blend_2 = ff["HAM8_BLND_Y_SUPERSENS1_INERT_HI"][0]
...
def ham8_blend_z():
    s = control.tf("s")
    blend_1_a = ff["HAM8_BLND_Z_SUPERSENS1_DISP"][0]
    blend_1_b = ff["HAM8_BLND_Z_SUPERSENS1_DISP"][1]
    ...
    blend_2 = ff["HAM8_BLND_Z_SUPERSENS1_INERT_HI"][0]
...
def ham8_iso_x():
    s = control.tf("s")
    cont3 = ff["HAM8_ISO_X"][3]
    boost3 = ff["HAM8_ISO_X"][7]
...
def ham8_iso_y():
    s = control.tf("s")
    cont3 = ff["HAM8_ISO_Y"][3]
    boost3 = ff["HAM8_ISO_Y"][7]
...
def ham8_iso_z():
    s = control.tf("s")
    cont3 = ff["HAM8_ISO_Z"][3]
    boost3 = ff["HAM8_ISO_Z"][7]
