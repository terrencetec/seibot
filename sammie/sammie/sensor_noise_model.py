...
def sensor_noise_sei():
    ...
    plt.clf()
    plt.loglog(freq_data, noise_data, label="T240meas")
    plt.loglog(f_, n_sei, label="model")
    plt.title("Sensor noise seismometer")
    plt.grid(which="both")
    plt.legend()
    plt.savefig("../temp_analysis/noise_sei.png", dpi=300)
    return f_, n_sei
...
def sensor_noise_gs13():
    ...
    plt.clf()
    plt.loglog(freq_data, noise_data, label="GS13")
    plt.loglog(f_, n_gs13, label="model")
    plt.title("Sensor noise GS13")
    plt.grid(which="both")
    plt.legend()
    plt.savefig("../temp_analysis/noise_gs13.png", dpi=300)
    return f_, n_gs13
...
def sensor_noise_cps_z():
    ...
    plt.clf()
    plt.loglog(freq_data, noise_data, label="ADE_p25")
    plt.loglog(f_, n_cpsz, label="model")
    plt.title("Sensor noise CPS ADE_p25")
    plt.grid(which="both")
    plt.legend()
    plt.savefig("../temp_analysis/noise_cpsz.png", dpi=300)
    return f_, n_cpsz
...
def sensor_noise_cps_xy():
    ...
    plt.clf()
    plt.loglog(freq_data, noise_data, label="ADE_1")
    plt.loglog(f_, n_cpsxy, label="model")
    plt.title("Sensor noise CPS ADE_1")
    plt.grid(which="both")
    plt.legend()
    plt.savefig("../temp_analysis/noise_cpsxy.png", dpi=300)
    return f_, n_cpsxy


_,_ = sensor_noise_cps_xy()
_,_ = sensor_noise_gs13()
_,_ = sensor_noise_sei()
_,_ = sensor_noise_cps_z()